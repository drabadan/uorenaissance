...
* Info * : Tooltip:
*/
func healTarget(t uint32, b uint32, whileWaiting func()) {
...
func healOnce(backpack uint32, targets []uint32, approach bool, whileWaiting func()) bool {
...
func autoHealing(targets []uint32, approach bool) {
	...
	for {
		if !healOnce(backpack, targets, approach, nil) {
			break
		}
	}
}
